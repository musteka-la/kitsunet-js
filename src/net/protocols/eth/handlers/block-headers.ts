...
export class GetBlockHeaders<P extends IPeerDescriptor<any>> extends EthHandler<P> {
  ...
  async send<U extends any[]> (...msg: U & [Buffer | BN | number, number, number, boolean]): Promise<any> {
...
export class BlockHeaders<P extends IPeerDescriptor<any>> extends EthHandler<P> {
  ...
  async send<U extends any[]> (...msg: U & [number | Buffer | BN, number, number, number]): Promise<any> {
